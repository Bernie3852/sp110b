...
* printf():
    ...
    * 包含跳脫字元之輸出 :
    ...
    在完成本次專案後，我更了解C語言以及系統程式中，是如何用這些小小的積木，堆疊出現今如此強大的各種工具、各種系統，尤其在我親自設計規劃scanf()跟printf()之後，才意識到這兩個我們這麼常用的工具，茄功能竟然如此複雜且強大，而且我原先以為會是比較高挑戰性的printf()，在不設計格式字元的情況下複雜度意外的低，不過若是把格式部分帶入想必又是一大工程呢...